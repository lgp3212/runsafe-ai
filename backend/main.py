...
def get_crashes_near_me(lat: float, lng: float, radius_km: float = 1.0, days_back: int = 60, sapi=SafetyApi):
        ...
        if response.status_code == 200:
            ...
            return {
                ...
                "summary": {
                    ...
                    "safety_concern_level": "Critical" if total_fatalities > 0 else "High" if injuries > 0 else "Moderate" if total_crashes >= 3 else "Low"
                },
